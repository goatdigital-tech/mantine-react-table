...
import { useState, memo, useEffect, useRef, useMemo, useCallback, Fragment as Fragment$1, forwardRef, useReducer, createElement, useLayoutEffect } from 'react';
import { Highlight, CopyButton, Tooltip, UnstyledButton, Select, MultiSelect, TextInput, useDirection, TableTd, Skeleton, TableTr, Collapse, Box, ActionIcon, Text, TableTbody, Flex, Button, useMantineTheme, Menu, Switch, TableTh, TableTfoot, Checkbox, Badge, Autocomplete, RangeSlider, Popover, Transition, Indicator, Radio, Alert, Stack, TableThead, useMantineColorScheme, Table, lighten, darken, Modal, ScrollArea, LoadingOverlay, Progress, Group, Pagination, Paper } from '@mantine/core';
import { sortFns, constructRow, filterFns, Subscribe, flexRender as flexRender$1, aggregationFns, stockFeatures, createFilteredRowModel, createSortedRowModel, createPaginatedRowModel, createExpandedRowModel, createGroupedRowModel, createFacetedMinMaxValues, createFacetedRowModel, createFacetedUniqueValues, useTable } from '@tanstack/react-table';
                ...
                : ((_f = tableCellProps.children) !== null && _f !== void 0 ? _f : (jsxs(Flex, { className: clsx('mrt-table-head-cell-content', classes$l.content, (columnDefType === 'group' ||
                        ...
                        classes$l['content-center'], (tableCellProps === null || tableCellProps === void 0 ? void 0 : tableCellProps.align) === 'right' && classes$l['content-right'], column.getCanResize() && classes$l['content-spaced']), children: [jsxs(Flex, { __vars: {
                                ...
                                : (tableCellProps === null || tableCellProps === void 0 ? void 0 : tableCellProps.align) === 'center' &&
                                    ...
                                    (column.getIsSorted() || showColumnButtons) && (jsx(MRT_TableHeadCellSortLabel, { header: header, table: table }))] }), columnDefType !== 'group' &&
                            (showDragHandle ||
                                (columnActionsEnabled && showColumnButtons)) && (jsxs(Flex, { className: clsx('mrt-table-head-cell-content-actions', classes$l['content-actions']), children: [showDragHandle && (jsx(MRT_TableHeadCellGrabHandle, { column: column, table: table, tableHeadCellRef: {
...
const useMRT_TableOptions = (_a) => {
    ...
    return Object.assign({ aggregationFns,
        ...
        enableTopToolbar, features: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, stockFeatures), ((enableColumnFilters || enableGlobalFilter || enableFilters) &&
            !manualFiltering
